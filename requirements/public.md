...
2. **"Jump ▾"** — a dropdown disclosure listing every remaining day, each with its four day-quarter times as links. Clicking one jumps straight there via anchor and closes the disclosure, independent of scroll-snap. This is the reliable way to reach any quarter screen; don't assume scroll/swipe alone is enough.
