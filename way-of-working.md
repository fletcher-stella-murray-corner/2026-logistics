...
- [requirements/public.md](requirements/public.md) — the public site (`site/`): the Timeline (homepage) and Family Tree features. There is no admin site for this project; the sole editor hand-edits data files directly (see `00-index.md` → *Editing data*).
